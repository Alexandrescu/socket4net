...
namespace TestProject
{
	...
	public class TestSocketIOClient
	{
        ...
        public class ThePasser
        {
            public string message { get; set; }
        }

        public void example_with_text()
        {
            Console.WriteLine("Starting TestSocketIOClient My example...");

            socket = new Client("http://216.151.208.237:1337/"); // url to the nodejs / socket.io instance
            ...
            socket.On("connect", (fn) =>
            {
                ...
                ThePasser pass = new ThePasser() { message = "Hi there." };

                socket.Emit("message_to_server", pass);
